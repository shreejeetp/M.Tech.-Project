...
#define NO_CROSSOVER 60                 //controls the no. of times crossover/mutation will be done.
#define CNT_TYPE cont_rea1500            //controls the containers array to be used from data1 structure.
...
#define VM_TYPE vm_rea                  //controls the vm array to be used.
#define VM_SIZE 20                      //mentions the vm array size
